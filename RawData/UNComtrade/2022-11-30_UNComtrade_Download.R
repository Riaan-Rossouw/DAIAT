...
fwrite(comtrade.data, file = "Comtrade_monthly_data_201701-202210.csv", sep = ",", col.names = TRUE)
saveRDS(comtrade.data, file = "Comtrade_monthly_data_201701-202210.rds", compress = TRUE)
